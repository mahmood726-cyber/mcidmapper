        # Mcidmapper: Protocol Registration

        **Author:** Mahmood Ahmad, Royal Free Hospital, London, UK
        **ORCID:** 0009-0003-7781-4478
        **Registration Date:** 2026-03-28
        **Repository:** https://github.com/mahmood726-cyber/mcidmapper.git

        ## Objective

        MCIDMapper maps minimal clinically important differences across outcome measures and patient populations, supporting threshold-based meta-analytic decision frameworks.
        ...
        - Code: https://github.com/mahmood726-cyber/mcidmapper.git
        - Dashboard: https://mahmood726-cyber.github.io/mcidmapper/
